...
import static com.pypypraful.einvoicing.persistence.dynamodb.InventoryTableConstants.EXECUTION_ARN;
...
public class DBWorkflowMetadata {
    ...
    @DynamoDBHashKey(attributeName = EXECUTION_NAME)
    private String executionName;

    @DynamoDBRangeKey(attributeName = EXECUTION_ARN)
